...
$sql ="CREATE DATABASE raju00168589_19C";
...
$sql1="CREATE TABLE IF NOT EXISTS `answer` (
  `id` int(11) NOT NULL,
...
$sql3="CREATE TABLE IF NOT EXISTS `carsdescription` (
  `id` int(11) NOT NULL,
  `car_name` varchar(200) NOT NULL,
  `car_description` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;";

$sql4="CREATE TABLE IF NOT EXISTS `question` (
  `id` int(11) NOT NULL,
...
$sql6="CREATE TABLE IF NOT EXISTS `userage` (
  `id` int(11) NOT NULL,
  `age` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;";

$sql7="CREATE TABLE IF NOT EXISTS `visitor` (
...
$insert1="INSERT INTO `answer` (`id`, `questionId`, `answer`, `answerer`) VALUES
...
$insert2="INSERT INTO `cars` (`id`, `car_name`, `car_description`, `car_view_count`) VALUES
(1, 'TOYOTA COROLLA HYBRID ', 'It may look bland, but the Toyota Corolla is one of Australia’s favourite cars for a reason – it’s a safe choice. Add a hybrid powertrain.', 52),
(2, 'TOYOTA PRIUS ', 'Toyota’s other hybrid hatch consumes even less than the Corolla, thanks to a slightly more modern hybrid powertrain and aero-optimised exterior. ', 100),
(3, 'NISSAN LEAF', 'It’s the cheapest pure-electric vehicle available in Australia, and totally worth a look-in if you’re sticking to city runabouts.', 150),
(4, 'MITSUBISHI OUTLANDER PHEV', 'It’s a hybrid SUV, and anything this size that clocks a fuel efficiency figure under 5L/100km is a great option for anyone interested in keeping the greenhouse effect at bay. ', 200),
(5, 'AUDI A3 SPORTBACK e-TRON', 'The A3 plug-in may be conservative on the outside, but it’s stunning on the inside with great technology and classy design. The 1.4-litre petrol-electric hybrid is the most fuel efficient option.', 250),
...
(8, 'VOLVO XC90 ', 'It’s stylish, it’s spacious and it’s got seven seats. And, with the T8-spec petrol-electric hybrid engine and plug-in charging capability, it’ll be the most fuel efficient', 400);
";
$insert3="INSERT INTO `carsdescription` (`id`, `car_name`, `car_description`) VALUES
...
";
$insert5="INSERT INTO `user` (`id`, `username`, `password`, `email`, `dob`, `postal_address`, `gender`, `user_type`) VALUES
...
$insert6="INSERT INTO `userage` (`id`, `age`) VALUES
(1, 18),
(2, 20),
(3, 28),
(4, 23);";
$insert7="INSERT INTO `visitor` (`count`) VALUES
(20);";
...
$alter1="ALTER TABLE `answer`
  ADD PRIMARY KEY (`id`);";
$alter2="ALTER TABLE `cars`
  ADD PRIMARY KEY (`id`);";
$alter3="ALTER TABLE `carsdescription`
  ADD PRIMARY KEY (`id`);";
$alter4="ALTER TABLE `question`
  ADD PRIMARY KEY (`id`);";
$alter5="ALTER TABLE `user`
  ADD PRIMARY KEY (`id`);";
$alter6="ALTER TABLE `userage`
  ADD PRIMARY KEY (`id`);";
$alter7="ALTER TABLE `answer`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;";
$alter8="ALTER TABLE `cars`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;";
$alter9="ALTER TABLE `carsdescription`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;";
$alter10="ALTER TABLE `question`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;";
$alter11="ALTER TABLE `user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;";
$alter12="ALTER TABLE `userage`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;";
